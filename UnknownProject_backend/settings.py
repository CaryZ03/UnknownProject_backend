"""
Django settings for UnknownProject_backend project.
...
SECRET_KEY = 'django-insecure-di3^!=2+oj$s#+tv+$0ti=6_0j9dv2$dda6d87!-ic@33-4ous'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['182.92.86.71']
...
ROOT_URLCONF = 'UnknownProject_backend.urls'
